...
status: ready
description: "Validate that a fresh GitHub Actions implementation run creates a branch/PR with the synthetic Roadmap Agent git identity and normal AI trailers."
created: 2026-03-18
updated: 2026-04-04
...
- The change should state that autonomous GitHub Actions commits use `Roadmap Agent <roadmap-agent@users.noreply.github.com>` as the git author/committer while model attribution remains in `Co-authored-by` and `AI-*` trailers.
...
- [ ] The resulting commit is authored and committed by `Roadmap Agent <roadmap-agent@users.noreply.github.com>`.
...
- Confirm the commit author/committer is `Roadmap Agent <roadmap-agent@users.noreply.github.com>`.
